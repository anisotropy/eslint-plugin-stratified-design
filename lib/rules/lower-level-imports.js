...
module.exports = {
  ...
  create(context) {
    ...
    const makeModuleDir = (module) => {
      ...
      return {
        moduleDir: absModule ? path.dirname(absModule) : module,
        isNodeModule: !absModule,
      };
    };
    ...
    return {
      ImportDeclaration(node) {
        ...
        const { moduleDir, isNodeModule } = makeModuleDir(node.source.value);
