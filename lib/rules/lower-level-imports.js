...
const layerSchema = {
  oneOf: [
    { type: "string", pattern: dirPattern },
    {
      type: "object",
      properties: {
        name: {
  ...
  create(context) {
    ...
    return {
      ImportDeclaration(node) {
        ...
        if (isNodeModule(modulePath) || isInSubDirOfFileDir(modulePath)) return;
